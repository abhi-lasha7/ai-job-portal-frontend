      ...
      <div style={styles.statsRow}>
        {['ALL', 'PENDING', 'SHORTLISTED', 'ACCEPTED', 'REJECTED']
          ...
          <button
            key={status}
            style={filter === status ?
              styles.filterActive : styles.filterBtn}
              ...
              <div style={styles.cardMiddle}>
                ...
                {app.employerFeedback && (
                  <div style={styles.feedback}>
                    💬 <strong>Feedback:</strong> {app.employerFeedback}
                  </div>
                )}

                <p style={styles.date}>
                  Applied on: {new Date(app.appliedAt)
                    .toLocaleDateString()}
                </p>
              </div>
